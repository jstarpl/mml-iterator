...
import DefaultParams from "./DefaultParams.mjs";
import MMLParser from "./MMLParser.mjs";
...
export default class MMLIterator {
  constructor(source) {
    ...
    this._instrument = DefaultParams.instrument;
  ...
  [Syntax.Instrument](command) {
    this._instrument = command.value !== null ? command.value : DefaultParams.instrument;
  }
...
function isNoteEvent(command) {
  return command.type === Syntax.Note || command.type === Syntax.NoteAbsolute ||  command.type === Syntax.Rest;
}
